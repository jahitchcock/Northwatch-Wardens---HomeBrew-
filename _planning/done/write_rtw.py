content = """# Return to Waystone (Session 0)
...
path = "Season 1/Adventures/Opening/Return_to_Waystone_Session0.md"
with open(path, 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)

lines = open(path, 'r', encoding='utf-8').readlines()
print(f"Written {len(lines)} lines, no BOM: {open(path,'rb').read(3) != bytes([0xef,0xbb,0xbf])}")
