<!--
  Tags: Faction, Season-1, DM-Only, Arc-Aevorian-Echo, pre-templates
  Status: Canon
  Type: Faction
  Region: Northreach
  Linked: World Building/Organizations/Organizations_Overview.md, arcs/Season_1_The_Aevorian_Echo.md
-->

# Faction Response Document: The Aevorian Echo
...
**Mechanical Impact:**
- Every successful investigation → Warden r\Rep. +1
...
###### Clerics, Priests, Divine Casters
...
#### **Trigger Events:**
- Remove Disease spells fail in The Pale Sickness
...
- **High Priestess Aldara** (off-screen, major city): Calls for divine intervention; potentially threatens excommunication of those who accept "Aevorian compromises"
...
{{pageNumber,auto}}
{{footnote Faction Response Document: The Aevorian Echo}}
...
- Some priests accept Aevorian or echo-worshipping theology
...
### DRAGONS 
###### And Dragon-Born/Dragonkin Communities
...
### ACADEMIC / SCHOLARLY ORGANIZATIONS 
###### Wizards, Researchers, Collectors
...
- **Archmagus Theron** (off-region): "Aevor still speaks? Our greatest work and greatest failure..."
...
#### **Factional Split:**
- **Aevor Preservationists:** "We can coexist with the new order"
...
#### **Trigger Events:**
- Artifact prices spike ("Aevorian items" become hot commodity)
...
### MILITARY POWERS 
###### City Guards, Army, Mercenary Companies
...
#### **Trigger Events:**
- Echo cultists realize their faith may not save them
