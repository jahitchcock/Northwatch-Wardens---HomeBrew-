<!--
  ...
  Linked: Season 1/Adventures/The Pale Sickness/The Pale Sickness.md
-->

# The Pale Sickness — Monster Stat Blocks

This document contains Homebrewery-formatted stat blocks for creatures in The Pale Sickness. These can be copy-pasted into the adventure file or reference during play.
...
{{pageNumber,auto}}
{{footnote The Pale Sickness — Monster Stat Blocks}}
...
**Note:** Winter wolf stats (SRD). Key details:
- **CR 3** (700 XP)
- Large monstrosity
- **AC** 13 (natural armor)
- **HP** 75 (10d10+20)
...
**Note:** Yeti stats (SRD). Key details:
- **CR 3** (700 XP)
- Large monstrosity
- **AC** 12 (natural armor)
- **HP** 51 (6d10+18)
...
**Note:** Ice mephit stats (SRD). Key details:
- **CR 1/2** (100 XP)
- Small elemental
- **AC** 11
- **HP** 21 (6d6)
...
**Note:** Saber-toothed tiger stats (SRD). Key details:
- **CR 2** (450 XP)
- Large beast
- **AC** 12
- **HP** 52 (7d10+14)
