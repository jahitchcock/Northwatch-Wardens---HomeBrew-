...
### Location
**Position:** Mountain range between [Northreach](loc:locations/northreach/index.md) and [Solaris Dominion](loc:locations/solaris-dominion.md)
...
### Key Features
The Stonebound Depths stretch beneath the Ironspine Mountains, a jagged range dividing Solaris from the [Emberlands](loc:locations/emberlands.md).
...
- [Waystone Inn](loc:locations/northreach/waystone-inn.md) has dwarven-made furniture
...
**Stonebound Outposts:**
- Several in volcanic south ([Emberlands](loc:locations/emberlands.md))
- Mining operations
