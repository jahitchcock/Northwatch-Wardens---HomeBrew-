...
- **Saved each other:** One PC rescued the other; debt of honor
...
"You two were escorting a caravan when bandits attacked. What was the scariest moment? Who saved whom?"
}}
...
**Purpose:** Establishes PC relationship with the guild and motivation for joining.
...
- **Veteran Warden recommended it:** You met [minor NPC], they suggested the guild
...
- **Mentor:** Someone who taught you a skill (Marta for weapons, Elira for herbalism)
...
PC 1 knows Sylra (barmaid) as a childhood friend. PC 2 has a crush on Sylra. Built-in party tension for roleplaying.
}}
...
**DM:** *(Later in campaign)* Sister appears at Waystone Inn. She ran away to find the PC. Now what?
}}
...
- **If adventure fear:** This is a theme to explore in game
}}
...
{{note
**Fear Example:**
PC fears isolation. During an adventure, separated from party in ruins. Must navigate alone. Success = character growth.
}}
...
**Purpose:** Gauges PC attitude toward the Echo mystery and magical themes.
...
- **Utilitarian:** Magic is a tool like any other, neither good nor evil
- **Religious view:** Magic is a divine gift or forbidden power
}}
...
{{descriptive
**Example Hook:**
*Player: "I saw a wild magic outbreak destroy my village. I don't trust unstable magic."*
...
As the campaign progresses, ask: *"Does this place feel like home yet?"*
...
**Purpose:** Creates intrigue and personal plot hooks. PC shares with DM privately; introduce complications later.

#### 12. Who Would You Die to Protect?
**Purpose:** Immediately establishes emotional stakes. Ensure that person/ideal gets threatened so heroics matter.

#### 13. What's One Thing About You That Would Surprise Others?
**Purpose:** Creates depth beyond the stat block. *Example: "Gruff fighter secretly writes poetry."*

#### 14. What's Your Definition of Success?
**Purpose:** Defines character goals and end-game desires. Track progress and offer opportunities to achieve it.

#### 15. What Would You NEVER Do, No Matter the Stakes?
**Purpose:** Establishes moral lines and creates dilemmas that test boundaries.

{{note
**DM Note:** Don't cross this line as punishment; present a CHOICE to cross it or find another way.
}}
...
2. **Identify connections** between PCs and to the setting
3. **Note dramatic opportunities** for future sessions
4. **Create NPC ties** by assigning existing NPCs from the Roster

{{note
**Example Synthesis:**

**PC 1 (Ranger):** "Former soldier escaping military past, joined Wardens for fresh start. Fears isolation. Knows Mira Frostborn (fellow hunter). Values community over glory."

**PC 2 (Wizard):** "Scholar fascinated by pre-Calamity magic, came to frontier to study Echo. Trusts magic implicitly. Knows Lorewarden Elric. Left behind research partner in Solace (complicated relationship)."

**Connection:** Both arrived the same day. Ranger mistrusts Wizard's magical curiosity; Wizard admires Ranger's survival skills. Tension but growing respect.
}}
...
- PC seeking redemption → Stopping the cult offers atonement
...
**Hook:** Someone they failed to protect; opportunity for redemption

### The Mage
**Key Questions:** 9 (Relationship with magic), 1 (Why Northreach), 5 (Who they know)
**Focus:** Understanding the Echo, knowledge, magical ethics
**Hook:** Echo mystery is directly relevant; Elric becomes mentor
...
- **Resolution:** PC realizes they're not a god; they're a protector who does their best

**Mechanical Reward:** After arc completion, PC gains *Protector's Resolve*: Once per long rest, grant an ally advantage on a death save.
...
- **Session 9:** That NPC is endangered; PC must decide if they care
...
**Listen More Than You Talk:** Players reveal what excites them through answers. Build the campaign around their interests.

**Don't Force Connections:** If a player says "I don't know anyone here," that's valid. Create opportunities to MAKE connections.

**Seeds Not Scripts:** Integration answers are seeds for stories, not rigid plot requirements. Let them grow organically.

**Celebrate Growth:** When a PC evolves beyond their Session 0 answers, highlight it: *"Remember when you said you'd never trust a mage? Look at you now, working with Elric!"*

**Player Agency:** These prompts create hooks, but PLAYERS decide how their characters respond. Never railroad based on Session 0 answers.
