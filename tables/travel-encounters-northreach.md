...
- Monster shows evidence of Aevorian modification (crystalline growths, unnatural features)
...
- If lair is ancient, could contain Aevorian artifacts
...
- Information about Aevor (ruins? weapons?)
...
- Ancient ruins (knows about Aevor?)
...
- Has theories about Aevorian technology
...
#### **Echo Connection (🔵 possible):**
- Spirit is created by Echo (Aevorian curse?)
- Or: Spirit has knowledge of Aevor
...
#### **Possible Types:**
- **Tower:** Fallen wizard's tower (Aevorian?)
...
#### **Discoveries:**
- Artifacts (potentially Aevorian)
- Magical items
- Historical records/tablets
- Treasure
- Curse (if site is protected)

#### **Echo Connection (🔵 if Aevorian):**
- Structure itself is Aevorian (confirms sites scattered in region)
- Activation signs (crystalline growths, magical humming)
- Clues about Aevor's technology
- Connection to larger network reveals

#### **Follow-Up:**
- Party can report findings to Elric (reputation gain)
- If significant (like Aevorian site), faction interest emerges
...
- Aevorian artifacts (100-2000 gp research value)
...
#### **Echo Connection (🔵 if Aevorian artifacts):**
- Cache contains Aevorian items (technology, weapons)
