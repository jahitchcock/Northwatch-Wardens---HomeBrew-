...
└── Campaign Assets/
    ├── THE NORTHWATCH WARDENS - Charter.md     (full charter text)
    ├── THE NORTHWATCH WARDENS - Charter.json   (machine-readable)
    ├── DM Guild Roster.md                      (NPC secrets & campaign ties)
    └── NORTHWATCH WARDENS - Campaign Arc.md    (how adventures interlock)
```

### Key Files
- **Charter**: `Season 1/Campaign Assets/THE NORTHWATCH WARDENS - Charter.md`
...
- **Charter Text**: `Season 1/Campaign Assets/THE NORTHWATCH WARDENS - Charter.md`
