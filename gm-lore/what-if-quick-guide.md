...
*Prepared responses for out-of-the-box player decisions. Use this to adjudicate on-the-fly without losing campaign continuity.*
...
### Scenario 1: "We're Going Straight to Salsvault"
...
**Story Impact:** Never the "right" ending but it can work. Players inherit responsibility for maintaining peace. Moral weight of allowing genocide weapon to exist.
...
**Campaign Becomes:** Not "stop the Echo" but "manage the transition to new world order"
...
**When to Use:** Only if ENTIRE TABLE agrees to this path. Have serious out-of-game discussion first. This is valid but changes campaign fundamentally. You can also refuse this path if it conflicts with your table vision.
...
### Scenario 5: "We Want to Leave the Region"
...
**If Underleveled (Too Slow):** Campaign planned for level 4–5 but party is level 2:
...
**If Overleveled (Too Fast):** Campaign planned for level 4–5 but party is level 6:
...
### Scenario 10: "We Want to Experiment on Living Creatures"
...
> **When to Override:** If this happens, serious DM conversation needed. This crosses into actual torture content — use session zero safety tools.
...
### Scenario 14: "We Found Aevorian Technology/Magic Items and Want to Use It"
...
### Scenario 16: "We Want to Bribe/Manipulate an Important NPC"
...
**Examples:**
- Bribe Warden Quartermaster? Takes gold but later demands favor in exchange
...
### Scenario 17: "We Want to Tell Everyone About the Echo"
