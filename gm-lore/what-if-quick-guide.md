...
### Scenario 3: 
###### Murder Hobos vs. Settlements (Phase 1-2)

**Trigger:** If players are terrible and killing innocents
...
- **Artifact:** "Retrieve the Aevorian artifact before our enemies do"
- **Turf War:** "Eliminate the creatures defiling dragon territory"

### Scholars (Phase 1 & 2)

- **Research:** "Gather samples/artifacts for our studies"
- **Expedition:** "Explore Aevorian sites; map them for us"
- **Discovery:** "Decipher this Aevorian text"
...
This section provides ready-made responses to common player decisions that break the expected campaign path. Use this to adjudicate on-the-fly without losing campaign continuity.
...
#### SCENARIO 1: 
###### "We're Going Straight to Salsvault"

**Why It Happens:** Players are eager, or one player read too much.

**DM Response:**

#### First Pass (Level 1-2):
*Salsvault is dangerous and sealed*
...
#### **Mechanical Effect:**
- Players can learn some basic clues (it IS Aevorian, it IS the source)
...
### SCENARIO 2: 
###### "We Want to Negotiate With the Echo"
...
- **Kael Vanthys:** Recognition as legitimate successor to Aevor; offer to preserve Aevorian knowledge rather than destroy it
...
- **Non-Negotiable:** "Aevor's knowledge will be preserved and advanced"
...
### SCENARIO 4: 
###### "We Want to Destroy Salsvault BEFORE Understanding the Entity"
...
- Sacrificial ritual that overwrites Aevorian coding (requires sacrifice of high-level caster)
...
### SCENARIO 6: 
###### "We Accidentally Killed an Important NPC"
...
- **Response:** Depends on specific NPC. 
...
### SCENARIO 8: 
###### "Players Leveled Too Slowly/Too Fast"
...
### SCENARIO 9: 
###### "We Want to Execute Captured Prisoners"
...
### SCENARIO 10: 
###### "We Want to Experiment on Living Creatures"
...
### SCENARIO 11: 
###### "We Want to Resurrect the Echo After Defeating It"
...
### SCENARIO 12: 
###### "We Want to Negotiate With an Enemy Mid-Combat"
...
### SCENARIO 14: 
###### "We Found Aevorian Technology/Magic Items and Want to Use It"

**Why It Happens:** Players want power; Aevorian artifacts are powerful.
...
Long-term: Using Aevorian tech marks you as "Aevorian-sympathizer" to factions
...
- Using it around factions provides -2 to reputation with anti-Aevor factions
- Artifact absorption: If exposed to enough Echo energy, it might activate/transform

#### **Story Impact:**
- Normalizes Aevorian solutions (moral gray area)
...
### SCENARIO 16: 
###### "We Want to Bribe/Manipulate an Important NPC"
...
### SCENARIO 17: 
###### "We Want to Tell Everyone About the Echo"
...
### SCENARIO 18: 
###### "We Want to Evacuate an Entire Settlement"
...
### SCENARIO 19: 
###### "We Created a Cult/Political Faction Ourselves"
...
### SCENARIO 20: 
###### "We're Running Out of Gold/Supplies"
...
### SCENARIO 21: 
###### "We Want to Skip Summer/Fast-Forward Time"
...
### SCENARIO 22: 
###### "A Player Wants to Leave the Table"
...
### SCENARIO 23: 
###### "A Player Wants to Change Campaigns Mid-Season"
