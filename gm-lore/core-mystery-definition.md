<!--
  Tags: Arc, Season-1, DM-Only, Arc-Aevorian-Echo, pre-templates
  Status: Canon
  Type: Arc
  Region: Northreach
...
# The Aevorian Echo: Core Mystery Definition
...
The reactivation of ancient magical facilities left behind when the flying city of Aevor crashed during the Calamity, thousands of years ago. These facilities are designed as weapons against gods, dragons, and civilizations. Something—or someone—has begun systematically bringing them back online.
...
Depends on the entity controlling it (see Entity Options). Broad goals: complete pre-Calamity objectives, neutralize divine magic, eliminate dragons, establish control, prove Aevorian superiority.
...
{{pageNumber,auto}}
{{footnote The Aevorian Echo: Core Mystery Definition}}
...
**The Fall:**
- Gods unified to destroy Aevor during the Calamity
...
**Player Realization:** Aevor wasn't purely evil. It was ambitious, proud, and wrong about how to achieve its goals. But some of what it wanted (independence from divine control, survival against dragons) resonates with frontier ideals.

### Why Is Northreach Important?

**Geographical Reality:**
- Fragments of Aevor scattered across Eiselcross during the crash
...
**The Network:**
- Multiple Aevorian facilities are present underground
...
- Northreach has become a ground zero for Aevorian reactivation
...
**How It Survived:**
- Voluntarily entered magical stasis before Aevor's crash
...
- Believes Aevor's mission was righteous and necessary
...
**Motivations:**
- Finish what Aevor started (prove magic > divinity)
- Restore Aevorian order and philosophy
...
\column
**Why This Option:**
- Creates a sense of continuity (Aevor had reasons, still reflected in Echo)
- Allows negotiation (brilliant minds can discuss terms)
- Personal stakes (confronting someone who _understands_ Aevor)
- Tragic element (he's not wrong about everything)
- Political campaign (could be an NPC later)

**Campaign Tone:** Intellectual struggle; proving/disproving Aevor's philosophy

**Vulnerability:**
- Doesn't understand modern world well (miscalculates reactions)
- Overconfident in Aevorian superiority (underestimates current threats)
...
**The Entity:** AEON (Aevorian Emergent Optimizing Network), magical AI construct
...
**The Entity:** Vestige, an incomplete deity from Aevor's failed apotheosis experiment

**What It Is:**
- Aevor attempted to create their own god through ritual
...
**The Entity:** Zerathuul the Endless, ancient brass dragon fused with Aevorian technology

**What It Is:**
- Captured by Aevor during early history
- Subjected to extensive bio-magical modification
- Merged with Aevorian machines (cyborg-dragon)
- Survived as hybrid consciousness
- Now free but changed forever

**Current State:**
- Mind caught between draconic and mechanical nature
- Contains both dragon instinct and Aevorian logic
- Deeply traumatized but won't show weakness
- Driven by revenge against multiple enemies
- Both monster and victim

**Personality & Goals:**
- Combines draconic pride with cold Aevorian logic
- Hates gods (allowed capture) AND Aevor (tortured it)
...
**Goals:**
- Destroy both divine and Aevorian systems (neither deserve power)
...
- Embodiment of what Aevor's hubris created
...
- ✗ NOT: Full truth about Aevor or the Echo
...
**Weeks 3-4 (After The Pale Sickness):**
- ✓ YES: Salsvault is the source (ancient Aevorian ruins)
...
- ✗ NOT: What Aevor was trying to accomplish
...
- Aevor had valid criticisms of divine power
- Echo's methods are evil but goals resonate
- Stopping it might preserve problems Aevor tried to solve

**Question 3: What happens after?**
- If Echo is destroyed: Power vacuum, factions compete, rebuilding needed
- If Echo is negotiated with: Uneasy coexistence, Aevor tech in world, new ethics needed
...
**Companion Documents:**
- The_Aevorian_Echo.md (extended lore)
